...
const Navbar = () => {
  return (
      <nav className="fixed z-40 pt-28 ">
        <ul className=" bg-orange-50 flex flex-col pt-3 space-y-5 pt-6d overflow-y-auto h-[40rem] w-60 text-sm font-semibold font-mont ">
          <Link href="/Admin">
            <li className="flex space-x-2 pl-2">
              <Image
                className=""
         ...
         <Link href='/Admin/users' ><li className="flex space-x-2 pl-2">
            <Image
              className=""
